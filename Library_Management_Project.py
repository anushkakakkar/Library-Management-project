class Library:
    ...
    def displayAvailableBooks(self): #to display all avaiable books
    ...
    def borrowBook(self, name, bookname):
        if bookname not in self.books:
            print(
                f"{bookname} BOOK IS EITHER NOT AVAILABLE OR TAKEN BY SOMEONE. IF TAKEN BY SOMEONE PLEASE WAIT UNTIL THE BOOK IS RETURNED\n")
        else:
...
if __name__ == "__main__":
    ...
    Delhilibrary = Library(
        ["Alchemist", "Encyclopedia", "Rich&Poor", "Seven Habits of Highly effective people", "Ikigai", "The last lecture"])
    student = Student()
    track = []

    print("\t\t\t\t\t\tWELCOME TO THE DELHI LIBRARY\n")
    print("""PLEASE ENTER YOUR CHOICE AMONG THE FOLLOWING:-\n1. List of all books\n2. Borrow book\n3. Return book\n4. Donate book\n5. Track book\n6. Exit library\n""")
